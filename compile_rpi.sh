...
fpc   -Mdelphi   -Fu../base -Fu../libtools -FE../bin -oedtfile
edtfile.dpr
...
cd ../libtools
fpc   -Mdelphi   -Fu../kernel -Fu../base -FE../bin -ocheckvoc
checkvoc.dpr
fpc   -Mdelphi   -Fu../kernel -Fu../base -FE../bin -ochkprem
chkprem.dpr
fpc   -Mdelphi  -Fu../kernel -Fu../base -FE../bin -ocreatevd
createvd.dpr
...
fpc   -Mdelphi  -Fu../kernel -Fu../base -FE../bin -orelinfer
relinfer.dpr
fpc   -Mdelphi  -Fu../kernel -Fu../base -FE../bin -oreliters
reliters.dpr
fpc   -Mdelphi  -Fu../kernel -Fu../base -FE../bin -orenthlab
renthlab.dpr
fpc   -Mdelphi  -Fu../kernel -Fu../base -FE../bin -oreplthls
replthls.dpr
fpc   -Mdelphi  -Fu../kernel -Fu../base -FE../bin -otrivdemo
trivdemo.dpr
fpc   -Mdelphi  -Fu../kernel -Fu../base -FE../bin -ounhereby
unhereby.dpr
cd ../usrtools
fpc   -Mdelphi  -Fu../kernel -Fu../base -FE../bin -oabsedt absedt.dpr
fpc   -Mdelphi  -Fu../libtools -Fu../kernel -Fu../base -FE../bin -
ochklab chklab.dpr
fpc   -Mdelphi  -Fu../libtools -Fu../kernel -Fu../base -FE../bin -
oconstr constr.dpr
fpc   -Mdelphi  -Fu../libtools -Fu../kernel -Fu../base -FE../bin -
ofindvoc findvoc.dpr
...
fpc   -Mdelphi  -Fu../kernel -Fu../base -FE../bin -olisppars
lisppars.dpr
fpc   -Mdelphi  -Fu../kernel -Fu../base -FE../bin -olistvoc listvoc.dpr
fpc   -Mdelphi  -Fu../libtools -Fu../kernel -Fu../base -FE../bin -
orelprem relprem.dpr
